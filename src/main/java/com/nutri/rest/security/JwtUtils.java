...
public class JwtUtils {
    ...
    private final LogoutTokensRepository tokensRepository;

    public JwtUtils(LogoutTokensRepository tokensRepository) {
        this.tokensRepository = tokensRepository;
    }

    public String generateJwtToken(Authentication authentication) {

        SSOUser userPrincipal = (SSOUser) authentication.getPrincipal();
